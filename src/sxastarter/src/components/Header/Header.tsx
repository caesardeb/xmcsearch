            ...
            <div className="max-w-7xl mx-auto flex items-center flex-wrap justify-between">
              ...
              >
                ...
                <input
                  ...
                  className="w-full sm:max-w-sm bg-slate-200 border border-transparent float-right focus:bg-white focus:border-slate-300 focus:outline-none h-12 p-4 placeholder-slate-500 rounded text-slate-700 text-xl"
                />
              </form>
              <div
                id="menu-toggle"
